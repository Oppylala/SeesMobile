...
public class Reports extends AppCompatActivity implements PopupMenu.OnMenuItemClickListener {
    ...
    public void SendReportMessage() {
        final String StationSelect = Station.getSelectedItem().toString();
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(Reports.this);
        alertDialogBuilder
                .setMessage("Your Report has been sent Successfully, Do you want to report more?")
                ...
                .setPositiveButton("No",
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                Details.setText("");
                                StationSelect.equals("Select Station");
                                CrimeType.setText("");
                                ReportImage.equals("");
                            }
                        })
    ...
    public void updateUI(FirebaseUser currentUser) {
        String keyid = dbreff.push().getKey();
        dbreff.child(keyid).setValue(user);
    }

    public void registerUser() {
        String Area = Station.getSelectedItem().toString().trim();
        String Crime = CrimeType.getText().toString().trim();
        String Report = Details.getText().toString().trim();
        ...
        Reportcae = new reportcase(Area, Crime, Report, Email, imageid);

        dbreff.child(FirebaseAuth.getInstance().getCurrentUser().getUid())
                .setValue(Reportcae).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
            public void onComplete(@NonNull Task<Void> task) {
                ...
                if (task.isSuccessful()) {
                    ...
                    Toast.makeText(Reports.this, "Successfully Registered", Toast.LENGTH_LONG).show();
                    SendReportMessage();
